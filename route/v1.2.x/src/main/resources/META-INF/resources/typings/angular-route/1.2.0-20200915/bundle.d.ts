...
declare namespace ng.route {
    export interface ICurrentRoute extends ng.route.IRoute {
        locals: any;
...
declare namespace ng.route {
    export interface IRouteProvider extends ng.IServiceProvider {
        /**
         ...
         * @return {*}
         */
        when(path: string, route: ng.route.IRoute): IRouteProvider;
    }
}
declare namespace ng.route {
    export interface IRouteService {
        ...
        current?: ng.route.ICurrentRoute;
    }
}
