# JSweet angular-route candy

## Description

This project is a Java bridge to the angular-route library, so that angular-route can be used from Java (thanks to the JSweet transpiler).
