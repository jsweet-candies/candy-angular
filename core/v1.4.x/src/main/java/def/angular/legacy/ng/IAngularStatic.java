...
public abstract class IAngularStatic extends def.js.Object {
    ...
    /**
         ...
         */
    native public def.angular.legacy.ng.auto.IInjectorService bootstrap(Object element, String[] modules, IAngularBootstrapConfig config);
    /**
    ...
    native public def.angular.legacy.ng.auto.IInjectorService injector(Object[] modules, Boolean strictDi);
    ...
    /**
         ...
         */
    native public def.angular.legacy.ng.auto.IInjectorService resumeBootstrap(String[] extraModules);
    ...
    /**
         ...
         *     - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
         */
    native public def.angular.legacy.ng.auto.IInjectorService bootstrap(Object element, String[] modules);
    /**
         * Use this function to manually start up angular application.
         *
         * @param element DOM element which is the root of angular application.
         ...
         *     - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
         */
    native public def.angular.legacy.ng.auto.IInjectorService bootstrap(Object element);
    /**
         * Creates a deep copy of source, which should be an object or an array.
         *
         * - If no destination is supplied, a copy of the object or array is created.
    ...
    native public def.angular.legacy.ng.auto.IInjectorService injector(Object[] modules);
    native public def.angular.legacy.ng.auto.IInjectorService injector();
    /**
         * The angular.module is a global place for creating, registering and retrieving Angular modules. All modules (angular core or 3rd party) that should be available to an application must be registered using this mechanism.
         *
         * When passed two or more arguments, a new module is created. If passed only one argument, an existing module (the name passed as the first argument to module) is retrieved.
    ...
    /**
         ...
         * @param extraModules An optional array of modules that should be added to the original list of modules that the app was about to be bootstrapped with.
         */
    native public def.angular.legacy.ng.auto.IInjectorService resumeBootstrap();
    /**
         * Use this function to manually start up angular application.
         *
         * @param element DOM element which is the root of angular application.
         ...
         *     - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
         */
    native public def.angular.legacy.ng.auto.IInjectorService bootstrap(Object element, Function[] modules, IAngularBootstrapConfig config);
    /**
         * Use this function to manually start up angular application.
         *
         * @param element DOM element which is the root of angular application.
         ...
         *     - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
         */
    native public def.angular.legacy.ng.auto.IInjectorService bootstrap(Object element, Object[][] modules, IAngularBootstrapConfig config);
    /**
         * Use this function to manually start up angular application.
         *
         * @param element DOM element which is the root of angular application.
         ...
         *     - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
         */
    native public def.angular.legacy.ng.auto.IInjectorService bootstrap(Object element, Object[][] modules);
    /**
         * Use this function to manually start up angular application.
         *
         * @param element DOM element which is the root of angular application.
         ...
         *     - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
         */
    native public def.angular.legacy.ng.auto.IInjectorService bootstrap(Object element, Function[] modules);
    native public def.angular.legacy.ng.IAugmentedJQuery element(java.lang.String selector, Object context);
    native public def.angular.legacy.ng.IAugmentedJQuery element(def.dom.Element element);
    native public def.angular.legacy.ng.IAugmentedJQuery element(java.lang.Object object);
    native public def.angular.legacy.ng.IAugmentedJQuery element(def.dom.Element[] elementArray);
    native public def.angular.legacy.ng.IAugmentedJQuery element(def.jquery.JQuery object);
    native public def.angular.legacy.ng.IAugmentedJQuery element(def.js.Function func);
    native public def.angular.legacy.ng.IAugmentedJQuery element(Object[] array);
    native public def.angular.legacy.ng.IAugmentedJQuery element();
    native public def.angular.legacy.ng.IAugmentedJQuery element(java.lang.String selector);
}
