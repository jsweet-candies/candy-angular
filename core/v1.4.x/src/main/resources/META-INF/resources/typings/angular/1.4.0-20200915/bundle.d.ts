...
declare namespace ng.auto {
    export interface IInjectorService {
        ...
        annotate(inlineAnnotatedFunction: any[]);
...
declare namespace ng.auto {
    export interface IProvideService {
         ...
         * 
         * @param {string} name The name of the service to decorate.
         * @param {java.lang.Object[]} inlineAnnotatedFunction This function will be invoked when the service needs to be instantiated and should return the decorated service instance. The function is called using the injector.invoke method and is therefore fully injectable. Local injection arguments:
         * 
         * $delegate - The original service instance, which can be monkey patched, configured, decorated or delegated to.
         */
...
declare namespace ng {
    export interface IAngularStatic {
         ...
         * @param {java.lang.String[]} modules An array of modules to load into the application.
         ...
         * 
         * @param {T[]} obj Object to iterate over.
         ...
         * @param {java.lang.Object[]} src Source object(s).
         * @return {*}
         */
         ...
         * @param {java.lang.String[]} requires The names of modules this module depends on. If specified then new module is being created. If unspecified then the module is being retrieved for further configuration.
         ...
         * @param {java.lang.String[]} extraModules An optional array of modules that should be added to the original list of modules that the app was about to be bootstrapped with.
         * @return {*}
         */
         ...
         * 
         * @param {*} element DOM element which is the root of angular application.
         * @param {def.js.Function[]} modules An array of modules to load into the application.
         * Each item in the array should be the name of a predefined module or a (DI annotated)
         * function that will be invoked by the injector as a config block.
         * @param {*} config an object for defining configuration options for the application. The following keys are supported:
         * - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
         ...
         * 
         * @param {*} element DOM element which is the root of angular application.
         * @param {java.lang.Object[][]} modules An array of modules to load into the application.
         * Each item in the array should be the name of a predefined module or a (DI annotated)
         * function that will be invoked by the injector as a config block.
         * @param {*} config an object for defining configuration options for the application. The following keys are supported:
         * - `strictDi`: disable automatic function annotation for the application. This is meant to assist in finding bugs which break minified code.
...
declare namespace ng {
    export interface IFilterFilter {
        <T>(array: T[], expression: string, comparator: ng.IFilterFilterComparatorFunc<T>);

        <T>(array: T[], expression: string);

        <T>(array: T[], expression: string, comparator: boolean);

        <T>(array: T[], expression: ng.IFilterFilterPatternObject, comparator: boolean);

        <T>(array: T[], expression: ng.IFilterFilterPatternObject, comparator: ng.IFilterFilterComparatorFunc<T>);

        <T>(array: T[], expression: ng.IFilterFilterPredicateFunc<T>, comparator: ng.IFilterFilterComparatorFunc<T>);

        <T>(array: T[], expression: ng.IFilterFilterPredicateFunc<T>, comparator: boolean);

        <T>(array: T[], expression: ng.IFilterFilterPatternObject);

        <T>(array: T[], expression: ng.IFilterFilterPredicateFunc<T>);
    }
}
declare namespace ng {
...
declare namespace ng {
    export interface IFilterLimitTo {
         ...
         * @param {T[]} input Source array to be limited.
         ...
         * @return {T[]} A new sub-array of length limit or less if input array had less than limit elements.
         */
        <T>(input: T[], limit: string, begin: string);
         ...
         * @return {T[]} A new sub-array of length limit or less if input array had less than limit elements.
         */
        <T>(input: T[], limit: string, begin: number);
         ...
         * @return {T[]} A new sub-array of length limit or less if input array had less than limit elements.
         */
        <T>(input: T[], limit: number, begin: number);
         ...
         * @return {T[]} A new sub-array of length limit or less if input array had less than limit elements.
         */
        <T>(input: T[], limit: number, begin: string);
...
declare namespace ng {
    export interface IFilterOrderBy {
         ...
         * @return {T[]} Reverse the order of the array.
         */
        <T>(array: T[], expression: string, reverse: boolean);
         ...
         * Orders a specified array by the expression predicate. It is ordered alphabetically for strings and numerically for numbers. Note: if you notice numbers are not being sorted as expected, make sure they are actually being saved as numbers and not strings.
         * @param {T[]} array The array to sort.
         * @param {java.lang.String[]} expression A predicate to be used by the comparator to determine the order of elements.
         * @param {boolean} reverse Reverse the order of the array.
         * @return {T[]} Reverse the order of the array.
         */
        <T>(array: T[], expression: string[], reverse: boolean);
         ...
         * Orders a specified array by the expression predicate. It is ordered alphabetically for strings and numerically for numbers. Note: if you notice numbers are not being sorted as expected, make sure they are actually being saved as numbers and not strings.
         * @param {T[]} array The array to sort.
         * @param {java.util.function.Function<T,java.lang.Object>[]} expression A predicate to be used by the comparator to determine the order of elements.
         * @param {boolean} reverse Reverse the order of the array.
         * @return {T[]} Reverse the order of the array.
         */
        <T>(array: T[], expression: ((p1: T) => any)[], reverse: boolean);
...
declare namespace ng {
    export interface IModule {
         ...
         * Use this method to register work which needs to be performed on module loading.
         * 
         * @param {java.lang.Object[]} inlineAnnotatedFunction Execute this function on module load. Useful for service configuration.
         * @return {*}
         */
         ...
         * @param {java.lang.Object[]} inlineAnnotatedConstructor
         * @return {*}
         */
         ...
         * @param {string} name Name of the directive in camel-case (i.e. ngBind which will match as ng-bind)
         * @param directiveFactory An injectable directive factory function.
         * @param {java.lang.Object[]} inlineAnnotatedFunction
         * @return {*}
         */
         ...
         * 
         * @param {string} name The name of the instance.
         * @param {java.lang.Object[]} inlineAnnotatedFunction The $getFn for the instance creation. Internally this is a short hand for $provide.provider(name, {$get: $getFn}).
         * @return {*}
         */
...
declare namespace ng {
    ...
    export interface IQService {
         ...
         * 
         * @param {def.angularjs.ng.IPromise<?>[]} promises An array of promises.
         * @return {*}
         */
...
declare namespace ng {
    ...
    export interface IRootScopeService {
         ...
         * @param {java.lang.Object[]} args Optional one or more arguments which will be passed onto the event listeners.
         * @return {*}
         */
